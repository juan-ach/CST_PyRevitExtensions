...
NOMBRE_FAMILIA_TAG = None # Se definirÃ¡ al encontrar la familia
...
# ==================================================
# FunciÃ³n: calcular punto del tag (mÃ¡s robusto)
# ==================================================
def calcular_punto_tag(elem, dx=0, dy=0, dz=0):
    loc = elem.Location

    # Caso tÃ­pico: LocationPoint
...
# 1. Buscar familia disponible (version mas alta por variante)
...
# 4. Activar sÃ­mbolos si es necesario
...
# ==================================================
# Equipos mecÃ¡nicos en la vista activa
# ==================================================
...
# ==================================================
# CREACIÃ“N DE TAGS (UN SOLO TIPO PARA TODO)
# ==================================================
contador = 0

t = Transaction(doc, u"Etiquetar todos los equipos mecÃ¡nicos (evaporadores)")
t.Start()
...
for eq in equipos:
    ...
    for p_name in ["AspiraciÃ³n", "LÃ­quido", "W_Metro"]:
    ...
    # LÃ³gica especial para familias "Mueble"
    ...
    # Obtener el sÃ­mbolo correspondiente
    simbolo_tag = tag_symbols.get(tipo_a_usar)
    if not simbolo_tag:
        continue # No deberÃ­a pasar si validamos al inicio
...
popup = AutoClosePopup(
    u"Se etiquetaron {} equipos mecÃ¡nicos con:\nFamilia: '{}'\n(Tipos dinÃ¡micos usados)".format(
